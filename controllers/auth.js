...
const googleAuth = async(req, res)=> {
    ...
    res.redirect(`https://yarmarok.netlify.app/?accessToken=${accessToken}&refreshToken=${refreshToken}`)
}
...
const forgotPassword = async (req, res) => {
    ...
    const resetPasswordEmail = {
        ...
        target="_blank" href="https://yarmarok.netlify.app/#/api/auth/reset-password/${user._id}/${resetToken}">Змінити пароль</a>
        </div>
        `
    };
