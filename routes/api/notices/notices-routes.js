...
const { addNotice, getNoticesByCategory, getAllNotices, updateNotice, removeNotice, getNoticeById, toggleActive, removeNoticeFromFavorite } = require('../../../controllers/notices');
